...
<body>
  ...
  <div class="main">
    <div id="home" class="home-section home-hero align-outer bg-theme-1">
      ...
      <div id="homeBgImg" data-bg-img="<?php echo base_url(); ?>public-other/media/blurred-bg-7.jpg"></div> <!-- #homeBgImg -->
            ...
            <div id="slogin" class="home-form-col col-sm-6 col-md-5 col-md-offset-1 col-lg-4 col-lg-offset-2">
              <div class="panel panel-theme-2 wow fadeInUp">
                ...
                <div class="panel-body">
                  <form class="form home-subscribe-form form-lite" aname="verifymyNumber" id="verifymyNumber"  method="POST" action="http://localhost:8080/expenseprov2/phoneNumber/phoneUpdate">
                    <fieldset class="row">
                        <div><center>Dear <b><?php echo $whichEmail; ?></b>,  <br/><small>Your phone number will used to send sms and transaction code from time to time</center></small></div>
                      
                        <div class="form-group col-xs-12">
                        <label for="homeSubscribeEmail1">Enter Phone Number</label>
                       <input type="text" value="" name="phoneNumber1" id="phoneNumber1"  class="form-username form-control">
                      </div>
                        <hr/>
                      <div class="form-group col-xs-12">
                           <span id="errorCase"></span>
                        <button class="btn btn-block btn-lg btn-theme-2" name="sendSMS33" id="sendSMS33" >Update Phone Number</button>
                      </div>
