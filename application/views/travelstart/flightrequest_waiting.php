                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header" data-background-color="blue">
                                ...
                                <p class="category"><a href="<?php echo base_url(); ?>travels/XX00ooBatch"<button class="btn btn-xs btn-danger">View Batch</button></a></p>
                            </div>
                                ...
                                if($getFlightRequest){
                                  ...
                                  ?>
                                     ...
                                     <tr>
                                         ...
                                         <td><?php echo $this->adminmodel->getUsername($addedBy); ?></td>
                                         <td><button data-id="<?php echo $request_ID; ?>" onClick="toggle_visibility('popup-box')" class="btn btn-xs btn-success viewFlight">View</button>&nbsp;
                                            
                                         <?php
                                            if($addedBy == ""){
                                               echo "<a href='".base_url()."travels/addflightrequestX00000/$id/$request_ID/$newtitle'><button class='btn btn-xs btn-danger'>Add</button></a>"; 
                                            }else if($addedBy == $_SESSION['email']){
                                                echo "<a href='".base_url()."travels/addflightrequestX00000/$id/$request_ID/$newtitle'><button class='btn btn-xs btn-danger'>Add</button></a>"; 
                                            }else{
                                                echo "";
                                            }
					 ...
					 <?php
                                         if($addedBy == ""){
                                            echo "<button onClick='notapplication($request_ID)' class='btn btn-xs btn-info'>N/A</button>"; 
                                         }
