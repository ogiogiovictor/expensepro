                           ...
                           <div class="row">        
                                <div class="col-md-3">
                                    <div class="form-group label-floating">
                                        ...
                                        <input  type="text" class="form-controls" name="warefoffice" id="warefoffice" value="<?php echo $warefofficer; ?>"/>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group label-floating">
                                        ...
                                        <input  type="text" class="form-controls" name="hodEmail" id="hodEmail" value="<?php echo $hodEmail; ?>"/>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group label-floating">
                                        ...
                                        <input  type="text" class="form-controls" name="bankName" id="bankName" value="<?php echo $eBank; ?>"/>
                                    </div>
                                 </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group label-floating">
                                        ...
                                        <input type="number" class="form-controls" name="acctNum" id="acctNum" value="<?php echo $eAccount; ?>" />
                                    </div>
                                </div>
                                    ...
                                    <tr>
                                     <td>
                                       <input type="hidden" name="exid[]" id="exid" class="form-control" value="<?php echo $tid; ?>"/>
                                        ...
                                        <td><select name="tFromlocation[]" required id="tFromlocation" class="form-controls">
                                                <option value="<?php echo $tFrom; ?>"><?php echo $fromName; ?></option>
                                                    <?php echo $dLocation; ?>
                                            </select>
                                        </td>
                                        <td><select name="tTolocation[]" required id="tTolocation" class="form-controls">
                                                <option value="<?php echo $tTo; ?>"><?php echo $tToName; ?></option>
                                                    <?php echo $dLocation; ?>
                                                </select>
                                        </td>
                                        <td><input type="text" required name="exsDate[]" id="exsDate" placeholder="dddd-mm-dd" class="form-controls newdatelog" value="<?php echo $exsDate; ?>"/></td>
                                        <td><input type="text" required name="exrDate[]" id="exrDate" placeholder="dddd-mm-dd" class="form-controls newdatelog" value="<?php echo $exrDate; ?>"/></td>
                                        <td><textarea type="text" required name="purpose[]" id="purpose"  class="form-controls"><?php echo $purpose; ?></textarea></td>
                                        <td><select name="logistics[]" required id="logistics" class="form-controls">
                       ...
                       <!-- END OF THE FORM BUTTON -->
                            ...
                            <div class="row">  
                                 <div class="col-md-12">
                                     ...
                                     <center> <div> <button class="btn btn-primary btn-xs" type="submit" class="nowSubmitUpdate" id="nowSubmitUpdate"><i class="fa fa-bus" aria-hidden="true"></i> &nbsp;UPDATE & SEND</button>  </div></center>
                                 </div>
