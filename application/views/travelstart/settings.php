                               ...
                               if($getSet){
                                   ...
                                   foreach($getSet as $value){
                                        foreach($value as $get){
                                            echo "<tr><td>$get</td><td><a href='".base_url()."framework/legit/settings/nr/codebase/settingsb/procuretab/$get'>View</a>"
                                                    . "&nbsp;&nbsp; <a href='".base_url()."framework/legit/settings/nr/codebase/settingsb/procuretabdrop/$get'>Drop</a></td></tr>";
                                        }
                                   }
                               }
                               echo "</table>";
