                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header" data-background-color="blue">
                                <h4 class="title"><i style="color:white; font-size:20px;" class="fa fa-plane" aria-hidden="true"></i> <span class="tastkform"><span style="color:white">FLIGHT DETAILS FOR <?php echo strtoupper($staffName); ?> </span></span>&nbsp;<i class="fa fa-bus" aria-hidden="true"></i></h4>
                            ...
                            <div class="card-content">
                                    ...
                                    foreach ($dDetials as $get) {
                                        ...
                                        if($CurrencyType == 'naira'){
                                         ...
                                         $approvals = $this->travelmodel->getnewStatus($id);
                                                ...
                                                if ($approvals == 0) {
                                                    $newapproval = "Warefare Officer";
                                                } else if ($approvals == 1) {
                                                    $newapproval = "<span >Awaiting HOD Approval</span>";
                                                } else if ($approvals == 2) {
                                                    $newapproval = "<span>Awaiting ICU Approval</span>";
                                                } else if ($approvals == 3) {
                                                    $newapproval = "<span>Awaiting Payment</span>";
                                                } else if ($approvals == 4) {
                                                    $newapproval = "<span>Ready for Collection</span>";
                                                } else if ($approvals == 5) {
                                                    $newapproval = "<span>Not Approved By HOD</span>";
                                                } else if ($approvals == 6) {
                                                    $newapproval = "<span>Reject by ICU</span>";
                                                } else if ($approvals == 7) {
                                                    $newapproval = "<span>Cheque Sent for Signature</span>";
                                                } else if ($approvals == 8) {
                                                    $newapproval = "<span>Signed & Ready for Collection</span>";
                                                } else if ($approvals == 11) {
                                                    $newapproval = "<span>Closed</span>";
                                                } else if ($approvals == 12) {
                                                    $newapproval = "<span>Rejected By Accounts</span>";
                                                } else {
                                                    $newapproval = "<span>pending</span>";
                                                }
                               ...
                               <hr/>
                                ...
                                <div class="btn btn-danger btn-sm">Status : <?php echo $newapproval; ?></div>
                                ...
                                <?php 
                                $getretiredresult = $this->travelmodel->retirementdetails($id);
                                //print_r($getretiredresult);
                                if($getretiredresult){
                                    foreach($getretiredresult as $rem){
                                        $paidAmount = $rem->paidAmount;
                                        $retiredAmount = $rem->retiredAmount;
                                        $myBalance = $rem->myBalance;
                                    }
                                ...
                                <span style="background-color:#e8eaed; font-weight: bold; font-size:18px; padding:10px">RETIREMENT</span><br/>
                                <br/><table class="table table-bordered table-responsive table-striped" style="width:300px; float:right">
                                    <tr>
                                        <th>AMOUNT COLLECTED</th>
                                        <td><span style="color:red; font-weight: bold"><?php echo @number_format($paidAmount, 2); ?></span></td>
                                    </tr>
                                    <tr>
                                        <th>AMOUNT RETIRED</th>
                                        <td><span style="color:red; font-weight: bold"><?php echo @number_format($retiredAmount, 2); ?></span></td>
                                    </tr>
                                    
                                    <tr>
                                        <th>YOUR BALANCE</th>
                                        <td><span style="color:red; font-weight: bold"><?php echo @number_format($myBalance, 2); ?></span></td>
                                    </tr>
