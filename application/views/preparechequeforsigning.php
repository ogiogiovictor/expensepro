 <!--<script src="https://js.paystack.co/v1/inline.js"></script>-->
	                        ...
	                        <div class="card hidechequeform">
	                            ...
	                            <div class="card-content table-responsive">
                                        ...
                                        <form name="chequepreparation" id="chequepreparation" enctype="multipart/form-data" method="POST" onSubmit="return false;"> 
                                            ...
                                            <div class="col-md-12"><i style='color:red'>Note: select the bank you are paying from and enter the cheque number that have not been used before</i></div>
                                            ...
                                            <?php 
                                                ...
                                                foreach ($getbank as $get) {
                                                    ...
                                                    $dBank .= "<option  value=\"$bankNumber\">" . $bankName .'-'. $accountName .'-'. $bankNumber . '</option>';
                                                     }
                                                 }
                                        ...
                                        <div class="col-md-4">
                                                    ...
                                                    <input type="text" class="form-control datepicker" name="chequeManualDate" id="chequeManualDate"  />
                                                    </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <!--<button type="button" class="btn btn-google btn-sm" onclick="payWithPaystack()"> Pay </button>-->
  ...
  function payWithPaystack(){
    var handler = PaystackPop.setup({
      ...
      amount: $('#mainAount').val(),
      ref: ''+Math.floor((Math.random() * 1000000000) + 1), // generates a pseudo-unique reference. Please replace with a reference you generated. Or remove the line entirely so our API will generate one for you
      metadata: {
         custom_fields: [
            {
                display_name: $('#payee').val(),
