                                ...
                                <div class="">
                                    ...
                                    <table class="table table-responsive table-striped table-bordered">
                                        <tr>
                                            ...
                                            <th>Year</th>
                                            <th>Month</th>
                                            <th>Expense Unpaid<br/><small>(Amount)</small></th>
                                        </tr>
                                        <?php
                                        if ($getallResult) {
                                            ...
                                            foreach ($getallResult as $yget) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="<?php echo base_url(); ?>/userexpense/pickunpaidtransactions/<?php echo $dUnit; ?>/<?php echo $YEAR; ?>/<?php echo $Month; ?>"><span style="color:green"><?php echo @number_format($TotalSUM, 2); ?></a></span></td>
