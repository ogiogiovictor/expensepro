            ...
            <div id="slogin" class="home-form-col col-sm-6 col-md-5 col-md-offset-1 col-lg-4 col-lg-offset-2">
              <div class="panel panel-theme-2 wow fadeInUp">
                ...
                <div class="panel-body">
                  <form class="form home-subscribe-form form-lite" name="verifymyNumber" id="verifymyNumber"  method="POST" action="https://c-iprocure.com/expensepro/verify/sendsms">
                    <fieldset class="row">
                      ...
                      //  $phoneCall = substr_replace($mPhone, "xxx", 7);
                        ?>
                       <input type="text" value="<?php echo $mPhone; ?>" name="phoneNumber" id="phoneNumber" placeholder="Phone Number" class="form-username form-control">
                      </div>
                        
                      <div class="form-group col-xs-12">
                           <span id="errorCase"></span>
                         <input type="hidden" value="<?php echo $whichEmail; ?>" name="email" id="email" />
                        <button class="btn btn-block btn-lg btn-theme-2" name="sendSMS" id="sendSMS" >Send Code</button>
                      </div>
