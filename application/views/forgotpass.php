            ...
            <div id="slogin" class="home-form-col col-sm-6 col-md-5 col-md-offset-1 col-lg-4 col-lg-offset-2">
              <div class="panel panel-theme-2 wow fadeInUp">
                ...
                <div class="panel-body">
                  <form class="form home-subscribe-form form-lite" aname="processemailchecks" id="processemailchecks"  method="POST" onSubmit="return false;">
                    <fieldset class="row">
                      
                      <div class="form-group col-xs-12">
                        <label for="homeSubscribeEmail1">Email</label>
                       <input type="text" name="emailAddress" id="emailAddress" placeholder="Email Address" class="form-username form-control">
                      </div>
                        
                      <div class="form-group col-xs-12">
                           <span id="errorCase"></span>
                        <button class="btn btn-block btn-lg btn-theme-2" name="sendpassReset" id="sendpassReset" >Reset</button>
                      </div>
              ...
              <div style="display:none;" id="register" class="home-form-col col-sm-6 col-md-5 col-md-offset-1 col-lg-4 col-lg-offset-2">
              <div class="panel panel-theme-2 wow fadeInUp">
                <div class="panel-heading">
                  <h5>Registration</h5>
                </div>
                ...
                <div class="panel-body">
                  <form role="form" id="mainRegFom" action="" method="post"  class="form home-subscribe-form form-lite" onsubmit="return false;">
                    <fieldset class="row">
                      ...
                      <div class="form-group col-xs-12" id="mainbutton">
