                        ...
                        <div class="card">
                            ...
                            <div class="card-content">
                                ...
                                <form name="batingpayment" id="batingpayment" method="POST" onSubmit="return false;">
                                    <div id="batchError"></div>
                                      ...
                                      <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Title</label>
                                                <textarea readonly name="dTitle" id="dTitle" class="form-control" style="background-color:gainsboro"><?php echo $title; ?></textarea>
                                    ...
                                    <div class="col-md-12">
                                        <div class="alert alert-danger">Please note you are either to pay to an Account group or send the money
                                             to a cashier for payment. Especially if the money is less than 10,000.</div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <center><input id="paytoexpensepronow" name="paytoexpensepronow" type="submit" value="Send For Payment" class="btn btn-sm btn-danger"/></center>
                                    </div>
