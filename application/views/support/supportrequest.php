                         ...
                         <div class="col-md-12">
	                        <div class="card">
	                            <div class="card-header" data-background-color="blue">
                                        ...
                                        <p class="category">PORTHARCOURT AND ENUGU ONLY</p>
						...
						?>
	                                     ...
	                                     <tr>
                                          ...
                                          /*  if ($getApprovalLevel == 6 || $getApprovalLevel == 1) {
                                           ...
                                           ?>
                                           <?php
                                           if(($getApprovalLevel == 6 || $ifcheckITSUPPORT) && $approvals !== '11'){
                                           ...
                                           <?php
                                           if($ifcheckITSUPPORT && ($PaymentType == 2 && $approvals == '3')){
                                           ...
                                           <?php
                                           if($ifcheckITSUPPORT && ($PaymentType == 1 && $approvals == '3')){
