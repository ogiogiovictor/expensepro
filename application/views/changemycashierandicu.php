                         ...
                         <div class="col-md-8">
	                        <div class="card">
	                            <div class="card-header" data-background-color="blue">
                                        <h4 class="title">Edit Cashier Or ICU </h4>
							 ...
							 $id = $get->id;
                                        ...
                                        <form name="changemyrequestdetials" id="changemyrequestdetials" enctype="multipart/form-data" method="POST" onSubmit="return false;">
                                           ...
                                           ?>
                                             <div class="col-md-6">
                                                    <div class="form-group label-floating">
                                                    <label class="control-label">Select ICU</label>
                                                    <select class="form-control" name="changemyicu" id="changemyicu">
                                                        <option value="<?php echo $icus; ?>" ><?php echo $newicuvalues; ?></option>
                                                        <?php echo $icu; ?>
                                                    </select>
                                                    </div>
	                                      </div>
                                            ...
                                            <span id="cashierError"></span>
                                             <div class="col-md-12">
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <center><button class="btn btn-xs btn-primary sendnewcahsierrequest">Submit</button></center>
                                                    </div>
	                                     </div>
