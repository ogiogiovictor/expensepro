                         ...
                         <div class="col-md-12">
	                        <div class="card">
	                            <div class="card-header" data-background-color="blue">
                                        ...
                                        <p class="category">All Request by <?php echo $email; ?></p>
						...
						?>
	                                     ...
	                                     <tr>
                                            ...
                                            <td><?php echo $dateCreated; ?></td>
                                             <td><?php echo $this->adminmodel->getUsername($sessionID); ?></td>
                                          ...
                                          /*  if ($getApprovalLevel == 6 || $getApprovalLevel == 1) {
                                           ...
                                           ?>
                                           <?php
                                           if($getApprovalLevel == 2 || $getApprovalLevel == 6 || $getApprovalLevel == 1 && $approvals !== '4'){
                                        ...
                                        <?php
                                        $totalApproved = "";
                                            if($approvedrequestonly){
                                                foreach($approvedrequestonly as $mum){
                                                    $dAmount = $mum->dAmount;
                                                    
                                                    if($dAmount){
                                                        $totalApproved += $dAmount;
                                                    }
                                                    
                                                }
                                            }
                                        ?>
                                        <span class="btn btn-sm btn-success">Total Paid: <?php echo @number_format($totalApproved, 2); ?></span>
