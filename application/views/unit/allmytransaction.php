	                ...
	                <div class="row">
                         ...
                         <div class="col-md-12">
	                        <div class="card">
	                            <div class="card-header" data-background-color="blue">
                                        ...
                                        <p class="category"><?php echo $email; ?> &nbsp;&nbsp;&nbsp; <a class="btn btn-primary" onClick="window.history.back()">Back</a></p>
	                            ...
	                            <div class="card-content table-responsive">
	                                <table class="table table-condensed table-hover" id="hodall">
	                                    <thead class="text-primary">
	                                    	...
	                                    	<th>Date Created</th>
                                                <th>Requester</th>
	                                    	<th style="width:250px">Description of Item</th>
						...
						?>
	                                     ...
	                                     <tr>
                                            ...
                                            <td style="width:250px"><?php echo $ndescriptOfitem; ?></td>
                                            ...
                                            <td style="width:150px"><?php echo $newapproval; ?></td>
                                            <td> <?php
