...
if ($getallresultMainTable) {
    foreach ($getallresultMainTable as $tabledefinition) {
        ...
        echo "<td><button class='btn btn-xs btn-success fa fa-edit'></button>&nbsp;&nbsp;&nbsp;&nbsp;<button id='delicious' data-id='".$tabledefinition->$explodecolumnItem[0]."'  class='btn btn-xs btn-danger fa fa-trash'></button></td>";
        echo "</tr>";
    }
